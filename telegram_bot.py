...
class ChatGPT3TelegramBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        """
        await update.message.reply_text("/reset - Update the conversation\n"
                                        "/home - Display a message\n"
    ...
    async def home(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        chat_id = update.effective_chat.id
        self.openai.reset_chat_history(chat_id=chat_id)
        await context.bot.send_message(chat_id=chat_id, text="I am from Ukraine!! I am Ukrainian!!!")
